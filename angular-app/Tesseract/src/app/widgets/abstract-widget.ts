...
export abstract class AbstractWidget implements OnInit {
    ...
    initializeWidgetCallbacks(widgetSpecification: WidgetSpecification) {
        ...
        this.sliceService.registerSubscriber(widgetSpecification.widgetId, () => this.refetch(false), this.customOptions);
    ...
    abstract refetch(hard: boolean): void;
